...
export default function PlantsCard({ tree, handleSelected }: PlantsCardProps) {
      ...
      <div className="group w-full max-w-sm overflow-hidden rounded-3xl bg-white shadow-md ring-1 ring-gray-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
        ...
        <div className="p-5">
          ...
          <div className="mt-5 flex items-center justify-between border-t border-gray-100 pt-5">
            ...
            {/* Button */}{" "}
            <button onClick={handleBuy} className="flex items-center gap-2 rounded-xl bg-green-600 px-5 py-3 text-sm font-bold text-white shadow-sm transition-all duration-200 hover:bg-green-700 hover:shadow-lg active:scale-95">
              {" "}
              <Leaf size={18} /> BuyNow{" "}
            </button>{" "}
          </div>{" "}
